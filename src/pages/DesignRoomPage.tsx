...
import { UploadCloud, Palette, Wand2, Zap, CheckCircle, Download, Share2, Settings, HelpCircle, Image as ImageIcon, BedDouble, Lamp, Sofa, Utensils, Bath, Tv, Briefcase, Home as HomeIcon, X } from 'lucide-react';
      ...
      <main className="flex-grow container mx-auto px-2 sm:px-4 py-6 sm:py-8 grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 mt-12 sm:mt-16">
        ...
        <div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold py-3 sm:py-3.5 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:scale-105 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center text-base sm:text-lg"
          >
            {isLoading ? (
              <>
