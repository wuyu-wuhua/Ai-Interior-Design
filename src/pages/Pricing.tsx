    ...
    <div className="bg-gray-900 min-h-screen text-white pt-20">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex justify-center mb-10 gap-4">
          ...
          >
            ✨Yearly Get 2+ Months Free with Yearly!
          </button>
        </div>
        {/* 价格栏 */}
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <button className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105 text-center">Recharge now</button>
            </div>
          ))}
        </div>
      </div>
