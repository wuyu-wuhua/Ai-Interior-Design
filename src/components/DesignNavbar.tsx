      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          {user ? (
            ...
            <a href="/login" className="bg-pink-500 hover:bg-pink-600 text-white px-4 py-2 rounded-lg font-semibold shadow ml-4">Login with Google</a>
          )}
        </div>
        {/* 移动端汉堡按钮 */}
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-80 flex flex-col">
          <div className="flex justify-between items-center p-4 border-b border-gray-800">
            <div className="flex items-center">
              <img src="/images/图标.jpg" alt="Logo" className="h-8 w-8 mr-2 animate-spin-slow" />
              <span className="text-2xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent">Ai Interior Design</span>
            </div>
          ...
          <div className="flex flex-col items-center justify-center flex-1 space-y-8">
            ...
            {user ? (
              ...
              <a href="/login" className="bg-pink-500 hover:bg-pink-600 text-white px-8 py-4 rounded-lg font-semibold shadow text-xl mt-6">Login with Google</a>
            )}
          </div>
        </div>
      )}
